...
export default function ClientImport() {
  ...
  const previewMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({ variant: 'destructive', title: 'Failed to parse file', description: error?.message || 'An error occurred' });
    },
  });
  ...
  const downloadTemplate = async () => {
    try {
      ...
      toast({ variant: 'destructive', title: 'Download failed', description: error?.message || 'An error occurred' });
    }
  };
